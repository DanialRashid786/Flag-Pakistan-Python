...
# Write text on the flag
turtle.goto(125, -200)
turtle.color('green')
turtle.write("HAPPY INDEPENDENCE DAY", align="center", font=("Arial", 15, "bold"))
turtle.goto(125, -230)
turtle.color('white')
turtle.write("14th AUGUST", align="center", font=("Arial", 15, "bold"))
turtle.goto(125, -260)
turtle.color('Yellow')
turtle.write("DANIAL RASHID", align="center", font=("Arial", 15, "bold"))
turtle.goto(125, -270)
turtle.back(20)



# Draw line between "HAPPY INDEPENDENCE DAY" and "DANIAL RASHID"
turtle.penup()
turtle.goto(-85, -232)
turtle.pendown()
turtle.color('white')
